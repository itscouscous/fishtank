...
TOFSensors::TOFSensors(uint8_t front_pin, uint8_t left_pin, uint8_t right_pin,
...
bool TOFSensors::setI2CAddresses() {
  // All reset
  digitalWrite(_sht_left_sensor, LOW);    
  digitalWrite(_sht_right_sensor, LOW);
  digitalWrite(_sht_front_sensor, LOW);
...
int16_t TOFSensors::getFrontDistance() {
  return _front_distance;
}

int16_t TOFSensors::getLeftDistance() {
  return _left_distance;
}

int16_t TOFSensors::getRightDistance() {
